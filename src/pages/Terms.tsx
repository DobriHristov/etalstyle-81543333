...
const Terms = () => {
  ...
  const contentBg = (
    <>
      ...
      <p className="mb-4 leading-relaxed opacity-80">С достъпа до уебсайта на Etalstyle, вие се съгласявате с настоящите условия за ползване. Ако не сте съгласни с някое от условията, моля не използвайте сайта.</p>
      <h2 className="text-xl font-bold mt-8 mb-4">2. Услуги</h2>
      <p className="mb-4 leading-relaxed opacity-80">Etalstyle предоставя CNC рязане и фрезоване на различни материали. Всички поръчки подлежат на потвърждение и се изпълняват според договорените спецификации.</p>
      <h2 className="text-xl font-bold mt-8 mb-4">3. Интелектуална собственост</h2>
      <p className="mb-4 leading-relaxed opacity-80">Всички материали на този уебсайт, включително текст, изображения, лога и дизайн, са собственост на Etalstyle и са защитени от закона за авторското право.</p>
      <h2 className="text-xl font-bold mt-8 mb-4">4. Ограничение на отговорността</h2>
      <p className="mb-4 leading-relaxed opacity-80">Etalstyle не носи отговорност за щети, произтичащи от използването на уебсайта или невъзможността за достъп до него.</p>
  ...
  const contentEn = (
    <>
      ...
      <p className="mb-4 leading-relaxed opacity-80">By accessing the Etalstyle website, you agree to these terms of use. If you do not agree with any of the terms, please do not use the site.</p>
      <h2 className="text-xl font-bold mt-8 mb-4">2. Services</h2>
      <p className="mb-4 leading-relaxed opacity-80">Etalstyle provides CNC cutting and milling of various materials. All orders are subject to confirmation and are executed according to agreed specifications.</p>
      <h2 className="text-xl font-bold mt-8 mb-4">3. Intellectual Property</h2>
      <p className="mb-4 leading-relaxed opacity-80">All materials on this website, including text, images, logos, and design, are the property of Etalstyle and are protected by copyright law.</p>
      <h2 className="text-xl font-bold mt-8 mb-4">4. Limitation of Liability</h2>
      <p className="mb-4 leading-relaxed opacity-80">Etalstyle is not liable for damages arising from the use of the website or the inability to access it.</p>
